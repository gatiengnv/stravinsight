        ...
        <section className="py-20 relative overflow-hidden">
            ...
            <div className="container relative mx-auto">
                <div className="mx-auto mb-16 max-w-2xl text-center">
                    <span
                        className="inline-block px-4 py-1 rounded-full bg-orange-100 text-orange-800 font-medium text-sm mb-4">PRICING OPTIONS</span>
                    <h2 className="text-3xl font-bold tracking-tight sm:text-4xl" id={"pricing"}>A little price for a
                        lot of features</h2>
